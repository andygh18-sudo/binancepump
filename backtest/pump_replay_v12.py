#!/usr/bin/env python3
"""Pump Replay / Backtest Engine v12 - second-candle confirmation, efficiency, adverse-extension control and soft reliability."""
