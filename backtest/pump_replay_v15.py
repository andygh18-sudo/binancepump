...
def main():
    ...
    os.makedirs(os.path.dirname(a.output) or ".",exist_ok=True);json.dump(payload,open(a.output,"w"),indent=2);json.dump(cal,open("data/v15_1_calibration.json","w"),indent=2);print(json.dumps(payload,indent=2))
